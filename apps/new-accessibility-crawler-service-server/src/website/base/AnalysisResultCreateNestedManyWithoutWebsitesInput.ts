...
@InputType()
class AnalysisResultCreateNestedManyWithoutWebsitesInput {
...
export { AnalysisResultCreateNestedManyWithoutWebsitesInput as AnalysisResultCreateNestedManyWithoutWebsitesInput };

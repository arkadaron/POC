...
@InputType()
class AnalysisResultCreateNestedManyWithoutPagesInput {
...
export { AnalysisResultCreateNestedManyWithoutPagesInput as AnalysisResultCreateNestedManyWithoutPagesInput };

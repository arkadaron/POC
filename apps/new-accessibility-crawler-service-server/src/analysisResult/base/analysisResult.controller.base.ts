...
export class AnalysisResultControllerBase {
  ...
  @common.Get("/:id/accessibilityIssues")
  @ApiNestedQuery(AccessibilityIssueFindManyArgs)
  async findAccessibilityIssues(
    @common.Req() request: Request,
    @common.Param() params: AnalysisResultWhereUniqueInput
  ): Promise<AccessibilityIssue[]> {
    const query = plainToClass(AccessibilityIssueFindManyArgs, request.query);
    const results = await this.service.findAccessibilityIssues(params.id, {
      ...query,
      select: {
        id: true,
        createdAt: true,
  ...
  @common.Post("/:id/accessibilityIssues")
  async connectAccessibilityIssues(
    @common.Param() params: AnalysisResultWhereUniqueInput,
    @common.Body() body: AccessibilityIssueWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      accessibilityIssues: {
        connect: body,
  ...
  @common.Patch("/:id/accessibilityIssues")
  async updateAccessibilityIssues(
    @common.Param() params: AnalysisResultWhereUniqueInput,
    @common.Body() body: AccessibilityIssueWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/accessibilityIssues")
  async disconnectAccessibilityIssues(
    @common.Param() params: AnalysisResultWhereUniqueInput,
    @common.Body() body: AccessibilityIssueWhereUniqueInput[]
  ): Promise<void> {
    const data = {
